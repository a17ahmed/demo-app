    ...
    return (
        <div className="tw-flex  tw-bg-[var(--first-color)] tw-justify-between tw-items-center tw-p-2 tw-px-4">
            <div className="tw-flex tw-flex-col tw-justify-start">
                ...
                <span className="tw-text-lg tw-font-semibold tw-text-white tw-line-through tw-cursor-pointer tw-decoration-2">
                    CHECK
                </span>
            </div>
            ...
            <div className="tw-flex tw-items-center tw-text-[0.9rem] tw-text-gray-400">
                ...
                <div className="tw-flex tw-items-center tw-px-1 tw-gap-1 tw-flex-row tw-text-primary">
                    <TbBrandWhatsappFilled className="tw-text-white" /> <span className="tw-font-semibold tw-cursor-pointer">800 CHECK ME</span>
                </div>
                <span className="tw-text-gray-400 tw-px-2">|</span>
                <span>Follow us</span>
                <div className="tw-flex tw-flex-row tw-items-center tw-gap-2 tw-pl-2 tw-cursor-pointer">
                    <ImFacebook2 />
            ...
            {openedIn !== "login" && (
                <div className="tw-flex tw-items-center tw-flex-row tw-gap-5">
                    <IoNotifications className="tw-size-5 tw-text-white tw-cursor-pointer" />
                    <div className="tw-flex tw-flex-row tw-items-center tw-gap-3 tw-rounded-md tw-border tw-border-white tw-self-start tw-px-2 tw-py-1">
                        ...
                        <div className="tw-flex tw-flex-col tw-text-xs tw-text-white tw-cursor-pointer">
                            <span>
                                LIAM KETLY
                            </span>
                            <span>
